...
class Algolia_Compatibility
{
    ...
    {
        add_action('algolia_before_get_records', [$this, 'register_vc_shortcodes']);
        add_action('algolia_before_get_records', [$this, 'enable_yoast_frontend']);
        add_action('algolia_before_get_records', [$this, 'wpml_switch_language']);
        add_action('algolia_after_get_records', [$this, 'wpml_switch_back_language']);
    }
